...
describe RentalPresenter do
  ...
  describe '#current_action' do
    ...
    it 'should return ongoing rental' do
      user = create(:user, role: :admin)
      subsidiary = create(:subsidiary, name: 'Almeida Motors')
      category = create(:category, name: 'A', daily_rate: 10, car_insurance: 20,
      third_party_insurance: 20)
      ...
      create(:car, car_model: car_model, license_plate: 'TAT-1234',
          subsidiary: subsidiary)
      rental = create(:rental, status: :ongoing, category: category, subsidiary: subsidiary,
        start_date: 1.day.from_now, end_date: 10.days.from_now)
    ...
    it 'should return in review rental' do
      user = create(:user, role: :admin)
      subsidiary = create(:subsidiary, name: 'Almeida Motors')
      category = create(:category, name: 'A', daily_rate: 10, car_insurance: 20,
      third_party_insurance: 20)
      ...
      create(:car, car_model: car_model, license_plate: 'TAT-1234',
          subsidiary: subsidiary)
      rental = create(:rental, status: :in_review, category: category, subsidiary: subsidiary,
        start_date: 1.day.from_now, end_date: 10.days.from_now)
    ...
    it 'should return in review rental' do
      ...
      create(:car, car_model: car_model, license_plate: 'TAT-1234',
          subsidiary: subsidiary)
      rental = create(:rental, status: :finalized, category: category, subsidiary: subsidiary,
        start_date: 1.day.from_now, end_date: 10.days.from_now)
